...
recording core, the ring storage / retention core and the replay asset
(stream-copy remux) core are implemented.  Input sources (NDI / Camera), replay
playback / control and the UI are not implemented yet.
